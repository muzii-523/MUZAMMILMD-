/**
 * Auto-upgraded shim for original plugin auto-sticker.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as auto-sticker.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./auto-sticker.orig.js');
const fallbackCommand = 'auto-sticker';
