/**
 * Auto-upgraded shim for original plugin check-update.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as check-update.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./check-update.orig.js');
const fallbackCommand = 'check-update';
