/**
 * Auto-upgraded shim for original plugin dl-ringtones.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as dl-ringtones.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./dl-ringtones.orig.js');
const fallbackCommand = 'dl-ringtones';
