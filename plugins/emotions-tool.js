/**
 * Auto-upgraded shim for original plugin emotions-tool.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as emotions-tool.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./emotions-tool.orig.js');
const fallbackCommand = 'emotions-tool';
