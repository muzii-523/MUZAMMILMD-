/**
 * Auto-upgraded shim for original plugin delete-links.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as delete-links.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./delete-links.orig.js');
const fallbackCommand = 'delete-links';
