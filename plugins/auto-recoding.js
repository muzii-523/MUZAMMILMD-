/**
 * Auto-upgraded shim for original plugin auto-recoding.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as auto-recoding.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./auto-recoding.orig.js');
const fallbackCommand = 'auto-recoding';
