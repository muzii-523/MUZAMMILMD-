/**
 * Auto-upgraded shim for original plugin antilink-kick.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as antilink-kick.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./antilink-kick.orig.js');
const fallbackCommand = 'antilink-kick';
