/**
 * Auto-upgraded shim for original plugin block-unblock.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as block-unblock.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./block-unblock.orig.js');
const fallbackCommand = 'block-unblock';
