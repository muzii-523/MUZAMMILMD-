/**
 * Auto-upgraded shim for original plugin channel-react.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as channel-react.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./channel-react.orig.js');
const fallbackCommand = 'channel-react';
