/**
 * Auto-upgraded shim for original plugin check-uptime.js
 * Created to provide a uniform interface: module.exports = { command, description, handler }
 * The original code is backed up as check-uptime.orig.js.
 * Shim will attempt common exported functions: handler, run, default, or a function named after command.
 */
const orig = require('./check-uptime.orig.js');
const fallbackCommand = 'check-uptime';
